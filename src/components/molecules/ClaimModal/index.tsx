...
type Props = {
  ...
  wallet: any,
  openClaimModal: any,
  setOpenClaimModal: any,
  handleClaim: any
}

const ClaimModal = (props: Props) => {
  const { setOpenClaimModal, openClaimModal, handleClaim, wallet } = props;
